...
SGR.RE = (value) => new RegExp(`\\x1b\\[${value}m`, 'g');
...
SGR.RE.NORMAL_COLOR_OR_INTENSITY = SGR.RE(22);
SGR.NOT_ITALIC_NOT_FRAKTUR = SGR(23);
SGR.RE.NOT_ITALIC_NOT_FRAKTUR = SGR.RE(23);
SGR.UNDERLINE_OFF = SGR(24);
SGR.RE.UNDERLINE_OFF = SGR.RE(24);
SGR.BLINK_OFF = SGR(25);
SGR.INVERSE_OFF = SGR(27);
SGR.REVEAL = SGR(28);
SGR.NOT_CROSSED_OUT = SGR(29);
SGR.RE.NOT_CROSSED_OUT = SGR.RE(29);
SGR.FG_BLACK = SGR(30);
SGR.FG_RED = SGR(31);
SGR.FG_GREEN = SGR(32);
...
SGR.RE.DEFAULT_FOREGROUND_COLOR = SGR.RE(39);
SGR.BG_BLACK = SGR(40);
SGR.BG_RED = SGR(41);
SGR.BG_GREEN = SGR(42);
...
SGR.RE.DEFAULT_BACKGROUND_COLOR = SGR.RE(49);
SGR.FRAMED = SGR(51);
